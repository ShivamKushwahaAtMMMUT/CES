...
<!-- Header
   ...
   <div class="container">
      ...
      <main role="main">
         ...
         <!-- Jumbotron -->
         <div class="jumbotron">
            <h1>Notice Board admin pannel</h1>
            <p class="lead">A suitable title, content and validity of notice are mandatory for generating new notice. Notice is issued as soon as it is submitted. Do not keep notice title too long.</p>
            <p><a class="btn btn-lg btn-success" href="./generate_notice.php" role="button">Generate new notice</a>
            </p>
         </div>

         <!-- Example row of columns -->
         <h2 class="text-info">Active notices  &raquo;<hr/></h2>
         <div class="row">
            <?php 
         ...
         ?>
            <div class="col-lg-4" style="background-color:#F1F1F1; border:solid 4px #fff; border-style: dashed; margin-bottom: 0; height: 400px;">
               ...
               <div style="height: 50px; position: absolute; bottom: 0px; padding-top: 5px;">
                  <a class="btn btn-primary" href="./notice_handler.php?notice_id=<?php echo($row['notice_id']); ?>&edit=true" role="button">Edit &raquo;</a>
                  ...
                  <a class="btn btn-danger" href="./notice_handler.php?notice_id=<?php echo($row['notice_id']); ?>&delete=true" role="button">Delete &raquo;</a>
               </div>
            </div>
            <?php } ?>
         </div>
